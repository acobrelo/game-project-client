...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(data).done(ui.success);
	};
	...
	var onChangePassword = function onChangePassword(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.changePassword(data).done(ui.success);
	};

	var onIndex = function onIndex(event) {
	  event.preventDefault();
	  api.indexOfGames().done(ui.indexGames);
	};

	var currentHouse = 'none';
	var xHouse = 'none';
	var oHouse = 'none';
	var xImg = 'none';
	var oImg = 'none';
	var ravImg = '<img src="assets/images/ravicon.png"/>';
	var gryfImg = '<img src="assets/images/gryficon.png"/>';
	var slythImg = '<img src="assets/images/slythicon.png"/>';
	var huffImg = '<img src="assets/images/hufficon.png"/>';

	var setxHouseImg = function setxHouseImg() {
	...
	var setoHouseImg = function setoHouseImg() {
	...
	var houseSet = function houseSet() {
	  if (xHouse === 'none') {
	    xHouse = currentHouse;
	    currentHouse = 'none';
	...
	var onSelectHouse = function onSelectHouse(event) {
	  event.preventDefault();
	...
	var resetHouses = function resetHouses(event) {
	  event.preventDefault();
	  currentHouse = 'none';
	  $('#choose-house').show();
	  $('.house').show();
	...
	var isColWon = 'unknown';
	var winCol = function winCol() {
	  for (var i = 0; i < 3; i++) {
	...
	var isDiaWon = 'unknown';
	var winDia = function winDia() {
	...
	var houseWinner = function houseWinner() {
	...
	var winCounter = function winCounter() {
	  var xInc = void 0;
	  var oInc = void 0;
	...
	var playerImg = function playerImg() {
	  if (gameLogic.currentMove === 'x') {
	    $('#' + cell).html(xImg);
	  } else {
	    $('#' + cell).html(oImg);
	...
	var onUpdateBoard = function onUpdateBoard() {
	  var index = gameLogic.arrayKey.indexOf(cell);
	  gameLogic.recentIndex = index;
	  $('#toUpdate').find('.index').val(index);
	  var whoseMove = gameLogic.turn;
	  gameLogic.currentMove = gameLogic.player[whoseMove];
	  var currentMove = gameLogic.currentMove;
	  playerImg();
	  ...
	  winCounter();
	  api.updateGame().done(ui.success);
	};
	...
	var onCreateGame = function onCreateGame(event) {
	  ...
	  api.createGame().done(ui.newGameSuccess);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexOfGames = function indexOfGames() {
	  return $.ajax({
	    url: app.host + '/games/',
	    method: 'GET',
	    headers: {
	...
	var updateGame = function updateGame() {
	  var index = gameLogic.recentIndex;
	  var move = gameLogic.currentMove;
	  var won = gameLogic.won;
	  return $.ajax({
...
/***/ function(module, exports) {
	...
	var initialBoard = ['', '', '', '', '', '', '', '', ''];
	var arrayKey = ['a1', 'a2', 'a3', 'b1', 'b2', 'b3', 'c1', 'c2', 'c3'];
	//this board can get updated
	var boardArray = ['', '', '', '', '', '', '', '', ''];
	var recentIndex = null;

	var player = ['x', 'o', 'x', 'o', 'x', 'o', 'x', 'o', 'x'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var finishedArray = function finishedArray() {
	...
	var countTrue = function countTrue() {
	  for (var i = 0; i < count; i++) {
	    if (finished[i] === 'truea') {
	      wonGames.push('x');
	    }
	...
	var indexGames = function indexGames(data) {
	  finished = [];
	  wonGames = [];
